...
# make this config the only way to configure qutebrowser
...
c.aliases = {
    ...
    'q': 'close',
    'qa': 'quit',
    'redability' : 'spawn --userscript redability-js',
    'w': 'session-save',
    'wq': 'quit --save',
    'wqa': 'quit --save',
}

# session saving interval
c.auto_save.interval = 15000

# restore the session
c.auto_save.session = True

# backend web engine (webengine, webkit)
c.backend = 'webengine'
...
# show changelog after updates (major, minor, patch, never)
...
# Gruvbox Material
col_black    = "#292828" # base 00 snaoetuhsnteuh
col_d_red    = "#ea6962" # base 01
col_d_green  = "#a9B665" # base 02
col_d_yellow = "#d8a657" # base 03
col_d_blue   = "#7daea3" # base 04
col_d_purple = "#d3869b" # base 05
col_d_aqua   = "#89b482" # base 06
col_d_gray   = "#7c6f64" # base 07 eosuthsaetuh
col_l_gray   = "#a89984" # base 08
col_l_red    = "#b85651" # base 09
col_l_green  = "#8f9a52" # base 0A
col_l_yellow = "#c18f41" # base 0B
col_l_blue   = "#86948a" # base 0C
col_l_purple = "#ab6c7d" # base 0D
col_l_aqua   = "#72966c" # base 0E
col_white    = "#d4be98" # base 0F
col_black_0  = "#1c1c1c"
col_black_1  = "#32302f"
col_black_2  = "#383432"
col_black_3  = "#3c3836"
...
c.colors.completion.fg = col_white # can be a list[3]
...
c.colors.webpage.darkmode.policy.images = 'smart' # always / never / smart
...
## Type: Int
c.colors.webpage.darkmode.threshold.background = 234
...
c.fonts.default_family = ['Fira Code NerdFont']
...
## Type: String
c.hints.border = '1px solid #d8a657'

## Characters used for hint strings.
## Type: UniqueCharString
c.hints.chars = 'aoeuidhtns'
# c.hints.chars = 'aoeuidhtnspyfgcrlqjkxbmwvz'
...
c.spellcheck.languages = ['en-GB', 'en-US', 'hi-IN']
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'file:///home/samyak/.config/startpages/simpleClock/index.html'
...
c.url.searchengines = {
    'DEFAULT':'https://searx.be/search?q={}',
      ...
      'simkl':'https://simkl.com/search/?q={}',
...
config.bind('<Ctrl-Shift-b>', 'mpv')
config.bind('<Ctrl-Shift-m>', 'mpv')
